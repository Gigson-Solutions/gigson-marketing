...
export async function POST(req: Request) {
  ...
  const inputFields = {
    ...
    erpSystem: validated.value.erpSystem,
    erpModules: validated.value.erpModules?.join(','),
    erpUsers: validated.value.erpUsers,
    migrationNeeded: validated.value.migrationNeeded,
    integrationSystems: validated.value.integrationSystems?.map((value) => ({ value })),
    integrationDirection: validated.value.integrationDirection,
    integrationFrequency: validated.value.integrationFrequency,
    consultingScope: validated.value.consultingScope?.join(','),
    consultingEngagement: validated.value.consultingEngagement,
